...
- We test our code multiple times even during development
- Impossibile to have a clear picture of an entire application

---

## Reality

<img src={images.testCurve} />

https://www.cantierecreativo.net/blog/2015-03-27-to-test-or-not-to-test/

<Notes>

Importance of having tests from day 1
...
Example of Angular test, Angular way, we will not use it
...
Two problems: implementation, not easy to write
...
- Load tests ([JMeter](https://jmeter.apache.org/))
- Penetration tests
- Contract testing ([Pact](https://pact.io/), [Dredd](https://dredd.org/en/latest/))
...
Only an overview, don't go into details
...
Demos of Jamsine (Angular), Jest (React), Cypress
...
<img src={images.testingToolsCypress} />

<Notes>

Unit tests in Cypress not enough mature
