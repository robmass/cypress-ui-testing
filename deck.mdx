...
Useful if the code is reused a lot in our tests and it is more confortable to use it inside a chain.
...
<div>
    <div style={{color: "#F00", margin: "5rem 0", fontSize: "2rem"}}>
        This element ‘&lt;input&gt;’ is not visible because its content is being clipped by one of its parent elements,
...
TODO tips: wait, don't sleep, cleaning state beforeEach
