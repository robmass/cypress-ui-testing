...
<div>
  <img style={{ display: "inline-block", "margin-right": "10px" }} src={images.homepage} />
  <img style={{ display: "inline-block", "margin-right": "10px" }} src={images.creator} />
  <img style={{ display: "inline-block" }} src={images.itinerary} />
</div>
...
```ts file=./code/intercept.ts title="Stubbing request example"

```

```ts 2:2 file=./code/intercept.ts title="Stubbing request example" subtitle="Intercept"

```

```ts 3:15 file=./code/intercept.ts title="Stubbing request example" subtitle="Switch"

```

```ts 7:7 file=./code/intercept.ts  title="Stubbing request example" subtitle="Fixture"

```

```ts 17:17 file=./code/intercept.ts  title="Stubbing request example" subtitle="Call API"
...
```ts 2:25 file=./code/integration1.ts title="Integration test example" subtitle="intercept 🛰"
...
```ts 30:32 file=./code/integration1.ts  title="Integration test example" subtitle="Come on baby, click my button... 😏"
...
```ts file=./code/unit1.ts title="Unit Test - Test Example"

```

```ts 2:13 file=./code/unit1.ts title="Unit Test - Test Example"

```

```ts 5:18 file=./code/unit1.ts title="Unit Test - Test Example"

```

```ts 20:28 file=./code/unit1.ts title="Unit Test - Test Example"
...
```ts file=./code/unit2.ts title="Unit Test - Component Example"
